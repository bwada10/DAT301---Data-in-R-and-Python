...
$\small Y=-114.1 - 0.8162(X_1, ANTM) + 1.586(X_2,CI) + 0.5642(X_3, HUM)
  - 0.0004764(X_4, ANTM^2) - 0.005867(X_5,CI^2) + 0.005584(X_6,ANTM*CI) - 0.002245(X_7, CI*HUM)$
...
I can confidently conclude that we have developed the best model for predicting Cenetene's daily closing price using predictor variables: ANTM, CI, HUM, ANTM^2, CI^2, ANTM*CI, CI*HUM. 
